...
*A meta-metaphor for the roles people and agents play in augmented coding sessions.*

This is not a metaphor applied from outside.
A session already is a performance — entities entering and exiting,
roles shifting, multiple levels running simultaneously, a permanent
presence watching it all. The theatre frame names what is already happening.
...
### Cast
The roles that can be occupied in any session.
Not archetypes of people. Session states that any entity — human, agent,
hook, skill — can occupy and vacate.
...
### Audience
Who the performance is for, and what they bring.
...
Practitioners encounter the effect, not the mechanism.
Repo maintainers and forks need this.
...
This repo documents patterns for augmented coding.
The repo is itself an instance of the augmented scaffolding pattern.
The theatre documents the roles that play out in sessions built on this scaffold.
The scaffold was built by playing those roles.

The loop is not a coincidence. It was the point.

`/writer` — when you are ready to see the machinery.

---

## Entry points

New to this repo → `/orient`
Want to go deep on a concept → `/explore <concept>`
Need coaching on something specific → `/claudia`
Want to contribute something you've discovered → `/contribute`
Found the trap door → `/writer`
